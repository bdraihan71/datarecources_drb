                    ...
                    <div class="shadow-sm mb-3 single-news-border">
                        ...
                        <div class="row">
                            ...
                            <div class="ml-auto pr-2">
                                <div class="addthis_inline_share_toolbox news-share-buttons" :data-url="getUrl(item.source)" :data-title="getTitle(item.heading)" :data-description="getDescription(item.body)" :data-media="getImageUrl(item.image)"></div>
                            </div>
                        </div>    
