            ...
            <div class="col-md-12">
                ...
                <div class="card-deck mt-5">
                    <div class="card border-0">
                        ...
                        @endif
                        <a href="{{route('news.single',App\News::where('showing_area', 'world')->orderBy('created_at', 'desc')->skip(1)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'world')->orderBy('created_at', 'desc')->skip(1)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>
                        <a href="{{route('news.single',App\News::where('showing_area', 'world')->orderBy('created_at', 'desc')->skip(2)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'world')->orderBy('created_at', 'desc')->skip(2)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>
                        <a href="{{route('news.single',App\News::where('showing_area', 'world')->orderBy('created_at', 'desc')->skip(3)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'world')->orderBy('created_at', 'desc')->skip(3)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>
                        <a href="{{route('news.single', App\News::where('showing_area', 'world')->orderBy('created_at', 'desc')->skip(4)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'world')->orderBy('created_at', 'desc')->skip(4)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>
                    </div>
                    ...
                    <div class="card border-0">
                        ...
                        @else 
                            <p class="card-text main-text-color"><small>No news available</small></p>
                        @endif
                        <a href="{{route('news.single',App\News::where('showing_area', 'country')->orderBy('created_at', 'desc')->skip(1)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'country')->orderBy('created_at', 'desc')->skip(1)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>  
                        <a href="{{route('news.single',App\News::where('showing_area', 'country')->orderBy('created_at', 'desc')->skip(2)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'country')->orderBy('created_at', 'desc')->skip(2)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>
                        <a href="{{route('news.single',App\News::where('showing_area', 'country')->orderBy('created_at', 'desc')->skip(3)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'country')->orderBy('created_at', 'desc')->skip(3)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>
                        <a href="{{route('news.single', App\News::where('showing_area', 'country')->orderBy('created_at', 'desc')->skip(4)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'country')->orderBy('created_at', 'desc')->skip(4)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>
                    </div>
                    ...
                    <div class="card border-0">
                        ...
                        @else 
                            <p class="card-text main-text-color"><small>No news available</small></p>
                        @endif
                        <a href="{{route('news.single',App\News::where('showing_area', 'economy')->orderBy('created_at', 'desc')->skip(1)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'economy')->orderBy('created_at', 'desc')->skip(1)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>  
                        <a href="{{route('news.single',App\News::where('showing_area', 'economy')->orderBy('created_at', 'desc')->skip(2)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'economy')->orderBy('created_at', 'desc')->skip(2)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>
                        <a href="{{route('news.single',App\News::where('showing_area', 'economy')->orderBy('created_at', 'desc')->skip(3)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'economy')->orderBy('created_at', 'desc')->skip(3)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>
                        <a href="{{route('news.single', App\News::where('showing_area', 'economy')->orderBy('created_at', 'desc')->skip(4)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'economy')->orderBy('created_at', 'desc')->skip(4)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>  
                    </div>
                    ...
                    <div class="card border-0">
                        ...
                        @else 
                            <p class="card-text main-text-color"><small>No news available</small></p>
                        @endif   
                        <a href="{{route('news.single',App\News::where('showing_area', 'company')->orderBy('created_at', 'desc')->skip(1)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'company')->orderBy('created_at', 'desc')->skip(1)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>  
                        <a href="{{route('news.single',App\News::where('showing_area', 'company')->orderBy('created_at', 'desc')->skip(2)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'company')->orderBy('created_at', 'desc')->skip(2)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>
                        <a href="{{route('news.single',App\News::where('showing_area', 'company')->orderBy('created_at', 'desc')->skip(3)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'company')->orderBy('created_at', 'desc')->skip(3)->take(1)->get()->first()->heading ?? '#'), 0, 20))}}</small></a>
                        <a href="{{route('news.single', App\News::where('showing_area', 'company')->orderBy('created_at', 'desc')->skip(4)->take(1)->get()->first()->id ?? '#')}}" class="category-news-heading-border category-news"><small class="card-text main-text-color">{{implode(' ', array_slice(explode(' ', App\News::where('showing_area', 'company')->orderBy('created_at', 'desc')->skip(4)->take(1)->get()->first()->heading  ?? '#'), 0, 20))}}</small></a>
                    </div>
                </div>
